...
# 设置日志文件路径
log_file = r'C:\Users\ASUS\Desktop\111\log.txt'
...
def are_images_similar(hash1, hash2, threshold=0.60):
    max_diff = 64
    similarity = 1 - hamming_distance(hash1, hash2) / max_diff
    return similarity > threshold

source_directory = r'J:\pic4'
destination_directory = r'J:\已清洗_正样本'
