...
# folder_path = r'H:\pbh\重新标注样本\统计标签数量任务\保定'
# folder_path = r'H:\pbh\重新标注样本\统计标签数量任务\沧州'
# folder_path = r'H:\pbh\重新标注样本\统计标签数量任务\石家庄'
# folder_path = r'H:\pbh\重新标注样本\统计标签数量任务\衡水'
# folder_path = r'H:\pbh\重新标注样本\统计标签数量任务\邢台'
# folder_path = r'H:\pbh\重新标注样本\统计标签数量任务\邯郸'
# folder_path = r'H:\pbh\重新标注样本\统计标签数量任务\雄安'
